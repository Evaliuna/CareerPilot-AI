...
export default function Dashboard({ analysis, setActiveTab, onToggleStudyItem, completedStudyItems }) {
  const { 
    role, 
    readinessScore, 
    tier, 
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-4 flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-lg font-bold text-primary">15 Hours</span>
          </div>
        </div>
      </div>
